...
Sebuah aplikasi web fullstack untuk restoran "Nusa Rasa Resto" dengan sistem reservasi meja. Proyek ini dibuat sebagai showcase pribadi menggunakan NextJS dengan Pages Router dan berbagai tech stack modern.
...
(https://nusa-rasa-resto.vercel.app)
...
1. Clone repositori:
   ...
   ```bash
   git clone https://github.com/username/nusa-rasa-resto.git
   cd nusa-rasa-resto
   ```
...
3. Buat file .env dan konfigurasikan variabel lingkungan:
   ...
   EMAIL_FROM="noreply@nusarasaresto.com"
